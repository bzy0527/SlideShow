    ...
    ss.OnSlideClick = function (ev) {
        ...
        if (cmd.dataContext.ResourceUri != undefined && cmd.dataContext.ResourceUri != "") {
            ...
            if (mode == 100) {
                ...
                DBFX.Web.NavControls.UIViewController.ActivedViewController.NavToUIView(undefined, cmd.dataContext.ResourceText, function (uiView) {
                    ...
                    iframe.src = cmd.dataContext.ResourceUri;
